...
<div class="container">
  <div class="card main-card p-4 mt-5">
    ...
    <div class="alert alert-info text-center mb-4">Register a new user by scanning their RFID and filling out the form. The UI is now more responsive and mobile-friendly.</div>
    <form class="row g-3" action="insertDB.php" method="post">
      <div class="col-12">
        <label for="getUID" class="form-label">ID</label>
        <textarea name="id" id="getUID" class="form-control" placeholder="Please Scan your Card / Key Chain to display ID" rows="1" required readonly style="resize:none;"></textarea>
      </div>
      <div class="col-12">
        <label for="name" class="form-label">Name</label>
        <input id="div_refresh" name="name" type="text" class="form-control" required>
      </div>
      <div class="col-12">
