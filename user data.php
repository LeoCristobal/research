...
<body>
    <h2>NodeMCU V3 ESP8266 / ESP12E with PostgreSQL Database</h2>
    <ul class="topnav">
                ...
                <tbody>
                    <?php
                        ...
                        foreach ($pdo->query($sql) as $row) {
                            ...
                            echo '<td>
                                    <a class="btn btn-success" href="user data edit page.php?id=' . urlencode($row['id']) . '">Edit</a>
                                    <a class="btn btn-danger" href="user data delete page.php?id=' . urlencode($row['id']) . '">Delete</a>
                                  </td>';
                            echo '</tr>';
                        }
